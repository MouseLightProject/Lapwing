...
%                     fclose(tiff_struct.file) ;
                    ...
                    if  is_file_an_imagej_jumbo_tif ,
                        ...
                        self.typed_video_file_ = lapwing.Video_file_imagej_jumbo_tif(file_name) ;
                    else
                        self.file_type_ = 'tif' ;
                        self.typed_video_file_ = lapwing.Video_file_normal_tif(file_name) ;
                    end
                case '.mj2' ,
                    self.file_type_ = 'mj2' ;
                    self.typed_video_file_ = lapwing.Video_file_mj2(file_name) ;
                otherwise
