...
%             figure_height_min=400;
            ...
            self.to_start_button_h = ...
                ...
                'enable','off',...
                'Callback',@(src,event)(self.change_frame_abs(1)));
            ...
            self.frame_backward_button_h = ...
                ...
                'enable','off',...
                'Callback', ...
                @(src,event)(self.change_frame_rel(-1)));
            self.stop_button_h = ...
                uicontrol('Parent',self.figure_h,...
                'Style','pushbutton',...
                'String','O',...
            ...
            self.frame_forward_button_h = ...
                ...
                'enable','off',...
                'Callback',@(src,event)(self.change_frame_rel(+1)));
...
%             self.show_overlay=true;
        ...
        function indexed_frame=get.indexed_frame(self)
            % Get the current indexed_frame, based on model, z_index,
            % colorbar_min, and colorbar_max.
            frame=double(self.model.get_frame(self.z_index));
        ...
        function resize(self)
            ...
            z_index_text_baseline= ...
                layout_height-(frame_index_and_fps_editbox_frame_height+z_index_text_height)/2;
